...
import box from './../../img/box-full.jpg'
import boxOnly from './../../img/box-only-full.jpg'
import remoteOnly from './../../img/remote-only-full.jpg'
...
export const Full = () => {
  ...
  const prices = {
    "HD" : [24.99, 28.99, 32.99, 36.99],
    "4K" : [34.99, 38.99, 42.99, 46.99]
  }
  ...
  return (
    <div className="container mt-5 px-5">
      <div className="row">
        ...
        <div className="col-6">
          <h2>Offre Films/Séries</h2>
          <h5>A partir de 24.99 € / mois*</h5>
