...
import box from './../../img/box-movies.jpg'
import boxOnly from './../../img/box-only-movies.jpg'
...
export const Films = () => {
  ...
  const prices = {
    "HD" : [19.99, 22.99, 27.99, 31.99],
    "4K" : [29.99, 32.99, 37.99, 41.99]
  }
